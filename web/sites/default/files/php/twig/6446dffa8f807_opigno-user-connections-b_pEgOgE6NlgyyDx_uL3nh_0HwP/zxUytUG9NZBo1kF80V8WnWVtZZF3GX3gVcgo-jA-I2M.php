...
class __TwigTemplate_631c723af8807514354d2f087709f68b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 11
        if ( !twig_test_empty(twig_trim_filter(twig_striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["connections"] ?? null)))))) {
            // line 12
...
";
    ...
    {
        return new Source("", "modules/contrib/opigno_social/templates/opigno-user-connections-block.html.twig", "/var/www/web/modules/contrib/opigno_social/templates/opigno-user-connections-block.html.twig");
    }
